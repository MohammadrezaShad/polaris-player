  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium  transition-colors focus-visible:outline-hidden  disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        link: 'text-foreground-alt underline-offset-4 hover:underline',
        background: 'bg-background text-background-foreground hover:bg-background/90',
        icon: 'bg-background text-background-foreground hover:bg-primary rounded-full h-10 w-10 p-0',
        none: '',
      },
      size: {
